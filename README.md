...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Syne&weight=700&size=22&duration=3000&pause=1000&color=4F8EF7&center=true&vCenter=true&width=600&lines=Desenvolvedor+Front-end+%F0%9F%92%BB;2+anos+de+experi%C3%AAncia+profissional;Teleperformance+%C2%B7+Claro+%C2%B7+OBInvest;HTML+%C2%B7+CSS+%C2%B7+JS+%C2%B7+WordPress+%C2%B7+PHP)](https://git.io/typing-svg)
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      &nbsp;&nbsp;📡 <strong>Claro</strong> — front-end, back-end, code review, dailys e deploys
    </td>
  </tr>
  <tr><td colspan="2"><br/></td></tr>
  <tr>
    <td width="60px" align="center">📈</td>
    <td>
      <strong>Estagiário Front-end</strong> — OBInvest<br/>
      <sub>mai/2023 – out/2023 · 6 meses · Rio de Janeiro, RJ</sub><br/>
      Manutenção do site institucional com HTML, CSS e GitHub. Colaboração com UX/UI e automações com Python (Selenium + SMTP).
    </td>
  </tr>
</table>
...
[![Portfolio](https://img.shields.io/badge/🌐_Portfólio-0a0a0f?style=for-the-badge&logoColor=white)](https://miguelrfreitas.dev)
